...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/ProjectileSimulatorReal.css">
</head>
<body class="bg" >
 ...
 <div class="white-bg space">             
  ...
  <div class="container"><center>
    <br><br><br>
    <a href="ProjectileMotionSimulator.php"><button type="button" class="btn btn-primary btn-lg">Start Simulator</button></a>
    <br><br><br><br><br><br>
  </div></center>
</div> 
